...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "Lio Club London brings the famous Ibiza dinner-show concept to Mayfair, with live singers and performers entertaining between courses before the venue transforms into a full nightclub. It's the most complete theatrical birthday experience — dinner, show, and club in one seamless evening.",
        ],
      },
      {
      ...
      },
      {
        ...
        headingLevel: "h2",
        content: [
          "One of the most common birthday headaches is coordinating a restaurant and a club in the same evening. Maddox and Lio Club London both solve this by offering the complete evening under one roof.",
      ...
      },
      {
        ...
        content: [
          ...
          "Ministry of Sound takes this further with one of the most iconic sound systems in the world. Celebrating a birthday at Ministry is a bucket-list moment for any dance music fan — multiple rooms, world-class DJs, and The Box's legendary audio quality. The scale is bigger, the crowd is more diverse, and the feeling of celebrating in a venue that's genuinely part of music history adds weight to the occasion.",
        ],
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. Maddox offers Italian dining followed by a house music club, and Lio Club London combines gourmet dinner with live entertainment before transforming into a nightclub. Both eliminate the need to coordinate separate venues.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "For the Experience Seeker: Cirque Le Soir or Lio Club",
        headingLevel: "h2",
        content: [
          ...
          "Lio Club London offers a different but equally impressive experience: gourmet dinner surrounded by live performers, followed by a transformation into a full nightclub. For a birthday that's about the complete evening — food, entertainment, and dancing — Lio provides the most comprehensive experience.",
        ],
      },
      {
        heading: "For the Style-Conscious: TABU or Luxx Club",
        headingLevel: "h2",
        content: [
          "For women who care about aesthetics and atmosphere, TABU's Japanese underground design and Luxx Club's LED installations create the most visually striking birthday backdrops. Every photo looks incredible, the interiors are conversation starters, and the intimate sizes mean your group is part of the venue's energy rather than lost in it.",
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "For the Music Head: BEAT London or Ministry of Sound",
        headingLevel: "h2",
        content: [
          "Men who define their nights out by the music should look at BEAT London or Ministry of Sound. BEAT's sound system is exceptional, the house and tech house policy is uncompromising, and the atmosphere is about the music rather than the scene.",
          "Ministry of Sound is the legendary option — celebrating a birthday at one of the world's most iconic clubs carries genuine weight. Multiple rooms with different genres, a sound system that's entered music folklore, and the sense of celebrating somewhere that's genuinely part of cultural history. For the man who lives for dance music, there's no better birthday venue.",
        ],
      },
      {
