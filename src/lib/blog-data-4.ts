...
export const blogDataPart4: BlogPost[] = [
  {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        headingLevel: "h2" as const,
        content: [
          "The brunch sets the tone. For a birthday that leads into a Mayfair club night, choose a restaurant with energy - not a quiet cafe. You want a venue with a lively atmosphere, good cocktails or bottomless options, and enough space for your group to spread out and settle in. Mayfair, Soho, and Marylebone all have excellent brunch spots within walking distance of the clubs.",
  ...
  {
    slug: "birthday-planning-timeline-london",
    title: "A Birthday Planning Timeline: What to Organise and When",
    metaTitle: "Birthday Planning Timeline London: Eight Weeks to the Night",
    metaDescription: "A practical week-by-week timeline for planning a birthday at a London nightclub. From the first group message to the night itself, every step explained.",
    excerpt: "A practical week-by-week timeline for planning a birthday at a London club, from the first group message to the morning after the night itself.",
    ...
    sections: [
      ...
      {
        heading: "Six Weeks Out: Confirm the Venue and the Table",
        headingLevel: "h2" as const,
        content: [
      ...
      {
        heading: "One Week Out: Final Logistics",
        headingLevel: "h2" as const,
        content: [
      ...
      {
        heading: "The Day Before and the Night Itself",
        headingLevel: "h2" as const,
        content: [
    ...
    faqs: [
      { question: "How far in advance should I start planning a birthday at a London club?", answer: "Eight weeks is the sweet spot for a group of eight or more. Smaller groups can be organised in four to six weeks comfortably, but eight weeks gives you the best venue choice and the lowest stress level. Anything under a fortnight and your options narrow sharply, particularly on Saturday nights in peak season." },
      { question: "What is the most common mistake birthday organisers make on the timeline?", answer: "Asking for general availability instead of proposing two specific dates. Open-ended polls drag on for weeks and rarely produce a confirmed group. Send two dates, set a 48-hour reply window, and pick the one that works for the most people." },
      { question: "When should I collect money from the group?", answer: "At the three-week mark, with a seven-day deadline. Collecting deposits early proves who is genuinely coming and gives anyone with second thoughts a chance to bow out before the venue is fully committed. Trying to collect money on the night itself almost always creates awkwardness." },
